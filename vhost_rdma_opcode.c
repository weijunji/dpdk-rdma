...
struct vhost_rdma_wr_opcode_info vhost_rdma_wr_opcode_info[] = {
	[VIRTIO_RDMA_WR_RDMA_WRITE]				= {
		.name	= "VIRTIO_RDMA_WR_RDMA_WRITE",
		.mask	= {
	...
	[VIRTIO_RDMA_WR_RDMA_WRITE_WITH_IMM]			= {
		.name	= "VIRTIO_RDMA_WR_RDMA_WRITE_WITH_IMM",
		.mask	= {
			[IB_QPT_RC]	= WR_INLINE_MASK | WR_WRITE_MASK,
			[IB_QPT_UC]	= WR_INLINE_MASK | WR_WRITE_MASK,
		},
	...
	[VIRTIO_RDMA_WR_SEND_WITH_IMM]				= {
		.name	= "VIRTIO_RDMA_WR_SEND_WITH_IMM",
		.mask	= {
			[IB_QPT_SMI]	= WR_INLINE_MASK | WR_SEND_MASK,
			[IB_QPT_GSI]	= WR_INLINE_MASK | WR_SEND_MASK,
			[IB_QPT_RC]	= WR_INLINE_MASK | WR_SEND_MASK,
	...
	[VIRTIO_RDMA_WR_RDMA_READ]				= {
		.name	= "VIRTIO_RDMA_WR_RDMA_READ",
		.mask	= {
			[IB_QPT_RC]	= WR_READ_MASK,
		},
	},
	[VIRTIO_RDMA_WR_ATOMIC_CMP_AND_SWP]			= {
		.name	= "VIRTIO_RDMA_WR_ATOMIC_CMP_AND_SWP",
		.mask	= {
			[IB_QPT_RC]	= WR_ATOMIC_MASK,
		},
	},
	[VIRTIO_RDMA_WR_ATOMIC_FETCH_AND_ADD]			= {
		.name	= "VIRTIO_RDMA_WR_ATOMIC_FETCH_AND_ADD",
		.mask	= {
			[IB_QPT_RC]	= WR_ATOMIC_MASK,
		},
	},
	[VIRTIO_RDMA_WR_TSO]					= {
		.name	= "VIRTIO_RDMA_WR_TSO",
		.mask	= {
			/* not supported */
		},
	},
	[VIRTIO_RDMA_WR_SEND_WITH_INV]				= {
		.name	= "VIRTIO_RDMA_WR_SEND_WITH_INV",
		.mask	= {
			[IB_QPT_RC]	= WR_INLINE_MASK | WR_SEND_MASK,
			[IB_QPT_UC]	= WR_INLINE_MASK | WR_SEND_MASK,
			[IB_QPT_UD]	= WR_INLINE_MASK | WR_SEND_MASK,
	...
	[VIRTIO_RDMA_WR_RDMA_READ_WITH_INV]			= {
		.name	= "VIRTIO_RDMA_WR_RDMA_READ_WITH_INV",
		.mask	= {
			[IB_QPT_RC]	= WR_READ_MASK,
		},
	},
	[VIRTIO_RDMA_WR_LOCAL_INV]				= {
		.name	= "VIRTIO_RDMA_WR_LOCAL_INV",
		.mask	= {
			[IB_QPT_RC]	= WR_LOCAL_OP_MASK,
		},
	},
	[VIRTIO_RDMA_WR_REG_MR]					= {
		.name	= "VIRTIO_RDMA_WR_REG_MR",
		.mask	= {
			[IB_QPT_RC]	= WR_LOCAL_OP_MASK,
		},
	},
	[VIRTIO_RDMA_WR_BIND_MW]					= {
		.name	= "VIRTIO_RDMA_WR_BIND_MW",
		.mask	= {
			[IB_QPT_RC]	= WR_LOCAL_OP_MASK,
