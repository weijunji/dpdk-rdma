/*
 * Vhost-user RDMA device demo: crc32
 *
...
/*
 * crc32 with polynomial 0x04C11DB7, same result as linux kernel,
 * cannot use rte_hash_crc because it use 0x1EDC6F41 as polynomial
 */
uint32_t
